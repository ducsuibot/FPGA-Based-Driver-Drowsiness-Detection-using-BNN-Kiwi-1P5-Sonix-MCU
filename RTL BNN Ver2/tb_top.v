...
module tb_top();
    ...
    initial begin
        ...
        $display("# ==================================================\n#");
        $display("# STM32: Bat dau gui anh (72 bytes) qua SPI...");
        ...
        spi_img_cs = 1;
        $display("# STM32: Da gui xong! He thong FPGA bat dau xu ly mang AI...");
        ...
        if (result == 1)
            $display("# => KET LUAN CUA PHAN CUNG: MO MAT (1)");
        else
            $display("# => KET LUAN CUA PHAN CUNG: NHAM MAT (0)");
        $display("# ========================================");
        $finish;
    end
