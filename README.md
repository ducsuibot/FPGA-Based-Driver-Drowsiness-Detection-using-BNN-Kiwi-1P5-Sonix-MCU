...
| **FPGA & BNN Inference** | **Nguyễn Minh Đức**<br>**Dương Phan Quang Bách** | • Design the **Binary Neural Network (BNN)** architecture on FPGA Kiwi 1P5.<br>• Develop optimized **Line Buffers** and Datapath (XNOR-Popcount).<br>• Design FSM-based controllers and verify bit-accurate inference. |
